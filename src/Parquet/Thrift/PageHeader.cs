...
namespace Parquet.Thrift
{
   ...
   {
      int _crc;
      DataPageHeader _data_page_header;
      IndexPageHeader _index_page_header;
      DictionaryPageHeader _dictionary_page_header;
      DataPageHeaderV2 _data_page_header_v2;
