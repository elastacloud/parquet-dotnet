      ...
      public void TableWriterWritesExpectedTwoColumns()
      {
         ...
         var table = new DisplayTable()
         {
            ...
            Rows = new[] { new TableRow { Cells = new[] {
               new BasicTableCell { CellLineCount = 1, ContentAreas = new[] { new BasicCellContent { Value = expectedValue1.ToString() } } },
               new BasicTableCell { CellLineCount = 1, ContentAreas = new[] { new BasicCellContent { Value = expectedValue2.ToString() } } }
            } } }
